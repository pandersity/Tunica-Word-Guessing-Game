export const CONFIG = {
  ...
  //
  googleAnalytics: 'G-084817PXB0', // You can use this if you use Google Analytics
  ...
  availableLangs: ['en', 'es', 'fr'], // the options available to the user for translation languages
